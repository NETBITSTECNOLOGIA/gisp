class DigLibApp {
    ...
    async init() {
        ...
        if (fileName === 'browse.html' || fileName === 'index.php' || !fileName || fileName.trim === '') {
    ...
    async loadFeatured() {
            ...
            if (fileName === 'index.php' || !fileName || fileName.trim === '') {
...
//obter o nome do arquivo; adicionar ao escopo global; execute funções de destaque e de linha do tempo com base na página HTML
...
async function registerSW() {
    if ('serviceWorker' in navigator) {
        try {
            ...
            console.log('Registro do ServiceWorker falhou.');
        }
    } else {
