      ...
      <div class="col2 esquerda">
        <div class="destaca">
          ...
          <table style="width:100%; border: 2px solid black">
            ...
            <tr><td style="border-top: 2px solid"><small>Pagador</small><br>' . $nome . '<br />' . $doccliente . '</td></tr>
          </table>
          <br>
        </div>
      </div>
      <div class="col10 direita">
        <b> SIS GISP | 0001 |  ' . $ncobranca . '</b>
        <table style="width:100%; border: 2px solid black;">        
        <tr>
        ...
        <tr>
          ...
          <td style="border-right: 2px solid; border-top: 2px solid"><small>Qtde</small><br>&nbsp;</td>
        ...
        <tr>
        <td colspan="5" rowspan="5" style="border-right: 2px solid; border-top: 2px solid; font-size: 18px !important">
