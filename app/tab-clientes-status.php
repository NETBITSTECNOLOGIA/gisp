  ...
  if (count($find) >= 1) {
    foreach ($find as $key => $value) {
      ...
      if ($retorno['nome'] != '') {
        ...
        echo '<i class="text-red">Sem cadastro</i>';
      }
      ...
      echo '</a></td>
                  ...
                  <td>';
      if ($retorno['porta'] != '') {
        echo '<a href="http://' . $find[$key]['address'] . ':' . $retorno['porta'] . '" target="blank"><i class="fa fa-wrench"></i> accesar</a>';
      } else {
        echo '<a href="http://' . $find[$key]['address'] . '" target="blank"><i class="fa fa-wrench"></i> accesar</a>';
      }
      echo '
                  </td>
