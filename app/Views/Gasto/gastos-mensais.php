...
if (PermissaoCheck($idempresa, 'cadastrar-gasto', $iduser) == 'checked' or $_SESSION['tipouser'] == 'Admin') {
  echo '
...
if (mysqli_num_rows($sql) >= 1) {
  while ($dd = mysqli_fetch_array($sql)) {
    echo '<tr>
                                  ...
                                  <td>' . Real($dd['valor']) . '</td>
                                  <td>';
    if (PermissaoCheck($idempresa, 'alterar-gasto', $iduser) == 'checked' or $_SESSION['tipouser'] == 'Admin') {
      echo '
                                      <a onclick="alterarGasto(' . $dd['id'] . ')" title="alterar item"><i class="fa fa-edit fa-2x"></i></a>';
    }
    if (PermissaoCheck($idempresa, 'excluir-gasto', $iduser) == 'checked' or $_SESSION['tipouser'] == 'Admin') {
      echo '
