...
if (PermissaoCheck($idempresa, 'usuarios-login', $id) == 'checked' || $_SESSION['tipouser'] == 'Admin') {
  echo '  
              <label class="col-lg-2 col-md-2 col-sm-3">Alterar login
                <input type="text" class="form-control" placeholder="Login" name="login"/>
              </label>';
}
if (PermissaoCheck($idempresa, ' usuarios-alterarsenha', $id) == 'checked' || $_SESSION['tipouser'] == 'Admin') {
  echo '     
