...
<div>  
    ...
    <form method="post" action="insert-cad-contrato-cliente-localizacao.php" autocomplete="off">
    <div class="row">
...
echo '
            ...
            <div class="box-body">
                ...
                <input type="text" class="form-control hidden" name="idcontrato" value="' . $idcontrato . '"/>
