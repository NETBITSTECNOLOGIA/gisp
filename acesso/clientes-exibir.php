...
$id = $_GET['id'];
$query = mysqli_query($conexao, "SELECT cliente.*, user.id,user.nome as nomeparceiro FROM cliente 
LEFT JOIN user ON cliente.parceiro = user.id
WHERE cliente.id='$id'") or die(mysqli_error($conexao));
          ...
          <div class="box box-info">
            ...
            <div class="row">
              ...
              <div class="col-lg-12 col-md-6 col-sm-12">
                ...
                <a href="exibir-cliente-notas.php?id=' . $id . '&nomecliente=' . $dd['nome'] . '" class="btn bg-navy"><i class="fa fa-file-pdf-o"></i> Notas</a>
            ...
            <div class="box-body">
              ...
              <label class="col-lg-4 col-md-6 col-sm-12 col-xs-12">Parceiro
              <select type="text" class="form-control" name="parceiro" required>';
if ($dd['parceiro'] != 0) {
  echo '<option value="' . $dd['parceiro'] . '" style="color:red">' . $dd['nomeparceiro'] . '</option>';
} else {
  echo '<option value="">selecione</option>';
}
$query0 = mysqli_query($conexao, "SELECT * FROM user ORDER BY nome ASC") or die(mysqli_error($conexao));
while ($retorno = mysqli_fetch_array($query0)) {
...
echo '               
              ...
              <label class="col-lg-2 col-md-6 col-sm-12 col-xs-12">Situção
...
echo '
              ...
              <label class="col-lg-2 col-md-6 col-sm-12 col-xs-12">Forma de cobrança
              <select type="text" class="form-control" name="formadecobranca" required>';
if (!empty($dd['formadecobranca'])) {
  echo '<option value="' . $dd['formadecobranca'] . '">' . $dd['formadecobranca'] . '</option>';
}
echo '
              ...
              <label class="col-lg-2 col-md-6 col-sm-12 col-xs-12">Período de cobrança
              <select type="text" class="form-control" name="periododecobranca" required>';
if (!empty($dd['periododecobranca'])) {
  echo '<option value="' . $dd['periododecobranca'] . '">' . $dd['periododecobranca'] . '</option>';
}
echo '
              ...
              <label class="col-lg-2 col-md-6 col-sm-12 col-xs-12">Vencimento
               ...
               <label class="col-lg-2 col-md-6 col-sm-12 col-xs-12">Emitir nota
                <select type="text" class="form-control" name="emitirnota">';
if (!empty($dd['emitirnota'])) {
  echo '<option value="' . $dd['emitirnota'] . '">' . $dd['emitirnota'] . '</option>';
}
echo '
...
echo '
              ...
              <label class="col-lg-2 col-md-6 col-sm-12 col-xs-12">N° VOIP
                <input type="text" class="form-control" placeholder="Apenas números" name="voip" value="' . @$dd['voip'] . '"/>
              </label>
          ...
          <input type="text" class="form-control" id="link2" value="https://gisp.digital/acesso/cad-cliente-localizacao.php?idcliente=' . $id . '&idempresa=' . $idempresa . '"/>
          </label>
