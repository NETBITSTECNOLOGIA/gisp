      ...
      <div class="row">
        ...
        <form method="get">
          <div class="row">
            ...
            <label class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
              <a href="cobranca-relatorio-clientes.php" class="btn btn-default btn-block"><i class="fa fa-eraser"></i>  Limpar</a>
            </label>
            </div>
        </form>
        <br/>
          <div class="box box-info">
            ...
            <div class="col-lg-12">
              <center><h2>Relatório de cobrança</h2></center>
              </div>
            </div>
            <!-- /.box-header -->
            <div class="box-body>    
            <div class="table-responsive">
                ...
                while($dd = mysqli_fetch_array($query)){echo'
                    <tr>
                        <td>'.$n.'</td>
                        <td style="width: 20% !important"><a href="clientes-financeiro-exibir.php?id='.$dd['id'].'" target="_blank">'.strtoupper($dd['nome']).'</a></td>
                        <td>'.$dd['vencimento'].'</td>
                        <td></td>
                        <td></td>
                        <td></td>
