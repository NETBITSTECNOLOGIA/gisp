...
if (PermissaoCheck($idempresa, 'alterar-categoria', $iduser) == 'checked' or $_SESSION['tipouser'] == 'Admin') {
  echo '
                    <div class="col-xs-12 col-md-4 col-sm-4 col-lg-2">
...
if (PermissaoCheck($idempresa, 'alterar-fornecedor', $iduser) == 'checked' or $_SESSION['tipouser'] == 'Admin') {
  echo '
                    <div class="col-xs-12 col-md-4 col-sm-4 col-lg-2">
...
if (PermissaoCheck($idempresa, 'cadastrar-item', $iduser) == 'checked' or $_SESSION['tipouser'] == 'Admin') {
  echo '
                      <div class="col-xs-12 col-md-4 col-sm-4 col-lg-2">
...
<script>
  ...
  function saidaItem(id) {
    ...
    $.get('retorno-para-saida-estoque.php', {
      id: id
    }, function(data) {
