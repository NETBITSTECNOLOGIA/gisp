...
if ($ddc['emitirnota'] == 'sim') {
  echo '
                  <a href="exibir-cliente-notas.php?id=' . $id . '" class="btn btn-danger" style="margin:2px"><i class="fa fa-file-text-o"></i> Notas</a>';
}
echo '
...
<div class="modal" id="modalGerarBoleto" tabindex="-1" role="dialog">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <label class="col-md-6 col-sm-12">Forma de cobraça
        <input type="text" class="form-control" value="' . @$ddc['formadecobranca'] . '" readonly>
      </label>
      <label class="col-md-6 col-sm-12">Período de cobraça
          <input type="text" class="form-control" value="' . @$ddc['periododecobranca'] . '" readonly>
      </label>
