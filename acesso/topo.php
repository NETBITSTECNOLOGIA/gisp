...
echo'<li class="dropdown notifications-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              ...
              <span class="label label-warning">'; if($totalchamados >= 1){ echo $totalchamados; }else{ echo '0';}echo'</span>
            </a>
            <ul class="dropdown-menu">
              <li class="header">'; if($totalchamados >= 1){ echo $totalchamados; }else{ echo '0';}echo' <b class="text-blue">notificaçes</b></li>
              <li>
                <!-- inner menu: contains the actual data -->
                <ul class="menu">';
                if($totalchamados >= 1){
                  while($ret = mysqli_fetch_array($queryc)){
                    ...
                    <li><a href="exibir-chamado.php?id='.$ret['id'].'"><i class="fa fa-headphones text-blue"></i>'.
                      $ret['tipo'].' - ';
                     if($ret['situacao'] == 'ABERTO'){echo'<span class="label label-info">'.$ret['situacao'].'</span>';} 
                     if($ret['situacao'] == 'CANCELADO'){echo'<span class="label label-danger">'.$ret['situacao'].'</span>';}
                    if($ret['situacao'] == 'REABERTO'){echo'<span class="label label-default">'.$ret['situacao'].'</span>';}
                     if($ret['situacao'] == 'PENDENTE' OR $ret['situacao'] == 'PENDENTE'){echo'<span class="label label-warning">'.$ret['situacao'].'</span>';}
                    echo'
                      </a></li>';
                  }                  
                }else{echo'
          ...
          <li class="dropdown user user-menu">
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-footer">
                <div class="pull-left">';
                  if($_SESSION['tipouser'] == 'Admin'){ echo'
