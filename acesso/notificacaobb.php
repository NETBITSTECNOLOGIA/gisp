...
if($data != ''){
    foreach($data as $item){
        ...
        if($item['codigoEstadoBaixaOperacional'] == 1){ $sitbanco = '1 - BAIXA OPERACIONAL EMITIDA PELO BB'; }
        elseif($item['codigoEstadoBaixaOperacional'] == 2){  $sitbanco = '2 - BAIXA OPERACIONAL EMITIDA POR OUTRO BANCO'; }
        elseif($item['codigoEstadoBaixaOperacional'] == 3){  $sitbanco = '10 - CANCELAMENTO DE BAIXA OPERACIONAL'; }
