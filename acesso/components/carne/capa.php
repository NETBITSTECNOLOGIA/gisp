    ...
    <div class="grid">
      <div class="col2 text-center"><?php
                                    if (!empty($dd['logomarca'])) {
                                      echo '<img src="../logocli/' . $dd['logomarca'] . '" style="border-radius:45%"/>';
                                    } else {
      ...
      <div class="col5">
        ...
        <p>
          <?php if ($dd['fantasia'] != '') {
            echo '<strong>' . strtoupper($dd['fantasia']) . '</strong><br>';
          } else {
            echo '<strong>' . strtoupper($dd['nome']) . '</strong><br>';
          } ?>
      ...
      <div class="col5">
        ...
        <p>
          <?php if ($ret['fantasia'] != '') {
            echo '<strong>' . strtoupper($ret['fantasia']) . '</strong><br>';
          } else {
            echo '<strong>' . strtoupper($ret['nome']) . '</strong><br>';
          } ?>
