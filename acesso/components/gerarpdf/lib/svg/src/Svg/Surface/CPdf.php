...
class CPdf
{
     ...
     * The path to the directory containing the font metrics should be include_onced
     */
     ...
     * note that this include_onces the objects array, so these can be large.
     */
    public $checkpoint = '';
...
EOT;
    ...
    /**
     * an image object, will be an XObject in the document, include_onces description and data
     */
    ...
    function stream($options = '')
    {
        ...
        // 'Accept-Ranges' => 1 or 0 - if this is not set to 1, then this header is not include_onced, off by default
     ...
     * the current one.
     * this object will not appear until it is include_onced within a page.
    ...
    function setFontFamily($family, $options = '')
    {
        if (!is_array($options)) {
            if ($family === 'init') {
                ...
                // these font families will be used to enable bold and italic markers to be include_onced
