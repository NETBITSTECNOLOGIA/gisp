...
echo '
          ...
          <input type="text" class="form-control" id="link2" value="https://gisp.digital/acesso/cad-cliente-contrato-localizacao.php?idcliente=' . $id . '&idempresa=' . $idempresa . '&idcontrato=' . $idcontrato . '"/>
          </label>
