...
class RouterosAPI
{
    ...
    var $timeout   = 2;   //  tempo de tentativa de conexão
    var $attempts  = 1;     //  Contagem de tentativa de conexão
    var $delay     = 1;     //  Atraso entre tentativas de conexão em segundos
    ...
    /**
     * Write (send) data to Router OS
     * Gravar (enviar) dados para o sistema operacional do roteador
