...
while($ret = mysqli_fetch_array($query)){
    ...
    mysqli_query($conexao,"UPDATE contratos SET situacao='Ativo', atualizado=NOW() WHERE idcliente='$id'") or die (mysqli_error($conexao));                    
    mysqli_query($conexao,"UPDATE cliente SET situacao='Ativo', atualizado=NOW() WHERE id='$id'") or die (mysqli_error($conexao)); 
    echo persona('Cliente ativo');
