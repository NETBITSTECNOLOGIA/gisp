...
if($tipo == 1){
		...
		$ddu = mysqli_fetch_array($sql);
			if(empty($ddu)){ echo '<button class="alert alert-danger btn-block"><i class="fa fa-exclamation-triangle"></i> Usuário ou senha inválido!</button>';}  //se $dados_uu for vazio mostrar o erro
			else{
