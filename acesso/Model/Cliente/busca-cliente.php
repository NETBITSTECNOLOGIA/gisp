...
if (isset($_POST['queryString'])) {
    ...
    if (strlen($queryString) > 0) {
        ...
        <tr>
            ...
            <td>';
            if ($dd['nomeplano'] == '') {
                echo '<span class="label label-warning">sem plano</span>';
            } else {
                echo $dd['nomeplano'];
            }
            echo '</td>
            ...
            } elseif ($dd['situacao'] == 'Bloqueado' || $dd['situacao'] == 'Cancelado') {
                echo '<span class="label label-danger">' . $dd['situacao'] . '</span>';
            } elseif ($dd['situacao'] == 'Pêndencia') {
                echo '<span class="label label-warning">' . $dd['situacao'] . '</span>';
            } elseif ($dd['situacao'] == '') {
                echo '<span class="label label-info">sem nada</span>';
            }
            echo '</td>
